...
SECRET_KEY_BASE64 = os.environ.get("DJANGO_SECRET_KEY_BASE64")
if SECRET_KEY_BASE64 is not None:
    SECRET_KEY = base64.b64decode(SECRET_KEY_BASE64).decode()
else:
    raise ValueError("DJANGO_SECRET_KEY_BASE64 missing")

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["127.0.0.1", "appleshortenlink.ddns.net"]
